...
![image-20200315231540841](/images/image-20200315231540841.png){width=40%}
...
![image-20200316000043385](/images/image-20200316000043385.png){width=50%}
...
![image-20200315233958018](/images/image-20200315233958018.png){width=40%}

不难观察到，若方格纸宽度为$n$，则轮廓线的长度为$n+1$。特殊地，当$j = 0$时，轮廓线形状如图：

![image-20200315234209189](/images/image-20200315234209189.png){width=40%}
...
![image-20200316001325572](/images/image-20200316001325572.png){width=50%}

特殊地，当$j = n$时，我们发现有一条轮廓线竖直贴到了最右边。这并不是我们期望的状态，所以需要做一下修正：

![image-20200316002332701](/images/image-20200316002332701.png){width=50%}
...
![image-20200316104905653](/images/image-20200316104905653.png){width=50%}
...
![image-20200316003249977](/images/image-20200316003249977.png){width=50%}

1. $(\neq 0, 0)$的情形

   只有一个插头的情形，只需要把这个插头（对应的路）拓展一格就好了。我们可以向下做拓展：

   ![image-20200316113928163](/images/image-20200316113928163.png){width=50%}

   注意拓展后的插头类型和拓展前一致。如果当前$j \neq n$，还可以向右做拓展：

   ![image-20200316114228937](/images/image-20200316114228937.png){width=50%}
...
2. $(0, \neq 0)$的情形
   ...
   ![image-20200316115027562](/images/image-20200316115027562.png){width=50%}
...
3. $(0, 0)$的情形
   ...
   ![image-20200316115947885](/images/image-20200316115947885.png){width=50%}
...
4. $(\neq 0, \neq 0)$的情形
   ...
   ![image-20200316120553557](/images/image-20200316120553557.png){width=50%}
   ...
   **错！**
   ...
   - $(1, 1)$的情形
     ...
     ![image-20200316122142085](/images/image-20200316122142085.png){width=50%}
   ...
   - $(2, 2)$的情形
     ...
     ![image-20200316134439530](/images/image-20200316134439530.png){width=50%}
...
5. 障碍物的情形
   ...
   ![image-20200316135243207](/images/image-20200316135243207.png){width=50%}
